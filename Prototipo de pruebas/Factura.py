...
resultadoIVA=tk.StringVar()
resultadoi=tk.StringVar()
...
def calcular():
    ...
    if compro==True:
        ...
        resultado2.set(float(cantidad1.get())*float(precio2.get()))
        resultado3.set(float(cantidad1.get())*float(precio3.get()))
        resultado4.set(float(cantidad1.get())*float(precio4.get()))
        resultado5.set(float(cantidad1.get())*float(precio5.get()))
        resultado6.set(float(cantidad1.get())*float(precio6.get()))
        resultadoT.set("Subtotal: "+str(float(resultado1.get())+float(resultado2.get())+float(resultado3.get())+(float(resultado4.get())+float(resultado5.get())+float(resultado1.get())))
        resultadoiva.set("Iva: "+str(0.19*float(resultado1.get()+float(resultado.get()+float(resultado3.get()float(resultado4.get()+float(resultado5.get()+float(resultado6.get())))
        resultadoIVA.set("Total: "+str(1.19*float(resultado1.get())+float(resultado2.get())+float(resultado3.get()+float(resultado4.get()+float(resultado5.get()+float(resultado6.get())))
...
def limpiar():
    ...
    tk.Label(text="FACTURA", bg="black", fg="white").place(x=275,y=10)
    ...
    tk.Button(text="limpiar",width=10,height=1,bg="orange",command=limpiar).place(c=570,y=40)
    tk.Button(text="calcular",width=10,height=1,bg="orange",command=limpiar).place(c=570,y=70)

    tk.Lable(text="PRODUCTO ",bg="white").place(x=100,y=100)
    tk.Lable(text="CANTIDAD",bg="white").place(x=220,y=100)
    tk.Lable(text="PRECIO U. ",bg="white").place(x=320,y=100)
    tk.Lable(text="PRECIO T. ",bg="white").place(x=420,y=100)
    ...
    tk.Label(textvariable=resultadoIVA,justify="left").place(x=480,y=10)
